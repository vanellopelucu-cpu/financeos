...
export function DeleteDebtConfirmation({ open, onClose, debt, onConfirm }: DeleteDebtConfirmationProps) {
          ...
          <CardContent className="p-6">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary">
                  {debt.payments && debt.payments.length > 0
                    ? `${debt.payments.length} pembayaran telah tercatat`
            ...
            <div className="mb-4 rounded-xl bg-error-500/10 p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-text-secondary">
                  Tindakan ini tidak dapat dibatalkan. Semua data pembayaran terkait akan hilang.
                </p>
              </div>
            </div>
